...
*  ===========
*
*       SUBROUTINE QGEMMTR(UPLO,TRANSA,TRANSB,N,K,ALPHA,A,LDA,B,LDB,BETA,
*                         C,LDC)
*
*       .. Scalar Arguments ..
*       REAL*16 ALPHA,BETA
...
*> \verbatim
*>
*> QGEMMTR  performs one of the matrix-matrix operations
*>
...
*> \param[in] B
*> \verbatim
*>          B is REAL*16 array, dimension ( LDB, kb ), where kb is
...
*>
*  =====================================================================
      SUBROUTINE QGEMMTR(UPLO,TRANSA,TRANSB,N,K,ALPHA,A,LDA,B,LDB,
     +         BETA,C,LDC)
      IMPLICIT NONE
*
