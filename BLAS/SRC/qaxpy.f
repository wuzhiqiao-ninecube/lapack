...
*> \param[in] QA
*> \verbatim
*>          QA is QUADRUPLE PRECISION
*>           On entry, QA specifies the scalar alpha.
*> \endverbatim
*>
*> \param[in] QX
*> \verbatim
*>          QX is QUADRUPLE PRECISION array, dimension ( 1 + ( N - 1 )*abs( INCX ) )
*> \endverbatim
*>
*> \param[in] INCX
*> \verbatim
...
*> \param[in,out] QY
*> \verbatim
*>          QY is QUADRUPLE PRECISION array, dimension ( 1 + ( N - 1 )*abs( INCY ) )
*> \endverbatim
*>
*> \param[in] INCY
*> \verbatim
