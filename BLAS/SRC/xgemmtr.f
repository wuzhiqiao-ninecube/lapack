...
*  ===========
*
*       SUBROUTINE XGEMMTR(UPLO,TRANSA,TRANSB,N,K,ALPHA,A,LDA,B,LDB,BETA,
*                         C,LDC)
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> XGEMMTR  performs one of the matrix-matrix operations
*>
...
*>
*  =====================================================================
      SUBROUTINE XGEMMTR(UPLO,TRANSA,TRANSB,N,K,ALPHA,A,LDA,B,LDB,
     +         BETA,C,LDC)
      IMPLICIT NONE
*
